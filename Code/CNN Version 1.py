...
# Function to inverse scale the prediction
...
def plot_predictions(df, sequence_length, train_dates, test_dates, y_train, train_predictions, y_test, test_predictions):
    ...
    plt.title('Stock Market Prediction using CNN Version 1 for Ford')
...
if __name__ == "__main__":
    # Specifying Ford as the stock symbol and time range
    stock_symbol = 'f'  
