...
def main():
    ...
    # Creating and training the RNN model with multiple layers and bidirectional RNN
    model = Sequential()
    model.add(Bidirectional(SimpleRNN(128, return_sequences=True), input_shape=(sequence_length, 1)))
    ...
    plt.title('Stock Market Prediction using RNN Version 1 for Ford')
