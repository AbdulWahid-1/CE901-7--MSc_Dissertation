...
**A Note on the Full Thesis Document**

You might notice that the full PDF of my dissertation is not included in this repository. Because the paper is currently unpublished, I am keeping the full text private and using this GitHub strictly for the raw data, results, and technical outputs. However, if you are a recruiter or researcher reviewing my profile, I am more than happy to provide the full thesis PDF upon request.
